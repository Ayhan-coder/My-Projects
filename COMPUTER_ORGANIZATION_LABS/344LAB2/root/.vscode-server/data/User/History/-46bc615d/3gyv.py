...
while iteration < max_iterations:
    ...
    print(f"Arrived at {airport_names[current_airport]}")
    ...
    # Check if we can continue from here
    next_check = flight_navigation(current_airport, current_fuel)
    if next_check == -1:
        print(f"No westward route available from {airport_names[current_airport]}. Journey ends here.")
        break
