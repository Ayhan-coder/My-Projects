...
int main(void) {
    // H2 test with 40 million entries
    int n_ = 64000000;  // hash array size
    int m_ = 40000000;  // 40 million entries to place
    int t_ = 8;         // number of threads
    int k_ = 1000;      // window size for h_2
    int seed = 42;

    printf("H2 Extreme test (40 million entries): n=%d, m=%d, t=%d, k=%d\n", n_, m_, t_, k_);
