...
int main(void) {
    // H2 test with 10 million entries
    int n_ = 16000000;  // hash array size
    int m_ = 10000000;  // 10 million entries to place
    int t_ = 8;         // number of threads
    int k_ = 1000;      // window size for h_2
    int seed = 42;

    printf("H2 Giga test (10 million entries): n=%d, m=%d, t=%d, k=%d\n", n_, m_, t_, k_);
